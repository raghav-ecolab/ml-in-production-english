...
# MAGIC %md Load the San Francisco Airbnb listings - we'll use this to train a model.
...
# MAGIC %md **Navigate to the MLflow UI by clicking on the `Experiment` button on the top of the screen.**
# MAGIC 
