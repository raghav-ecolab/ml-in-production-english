...
# MAGIC #### Integration
# MAGIC 
# MAGIC Generally, **integration** refers to:<br><br>
# MAGIC 
...
# MAGIC 
# MAGIC Once code or artifacts are integrated, the updated software or artifacts need to be **delivered** or **deployed**:<br><br>
# MAGIC 
...
# MAGIC #### Continuous
# MAGIC 
# MAGIC You might be thinking: what makes these **continuous**?
# MAGIC 
# MAGIC Generally speaking, **continuous** means in rapid succession &mdash; to efficiently and frequently integrate and deploy software.
...
# MAGIC 
# MAGIC This process usually follows a workflow like:<br><br>
# MAGIC 
...
# MAGIC 
# MAGIC But when using CI/CD for machine learning, we aren't quite done once we deploy:<br><br>
# MAGIC 
...
# MAGIC %md-sandbox <div><img src="https://files.training.databricks.com/images/eLearning/ML-Part-4/Model-Staleness.png" style="height: 450px; margin: 20px"/></div>
