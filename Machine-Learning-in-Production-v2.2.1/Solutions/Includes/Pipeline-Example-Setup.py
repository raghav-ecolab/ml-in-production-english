...
airbnb_df = spark.read.format("delta").load("dbfs:/mnt/training/airbnb/sf-listings/sf-listings-2019-03-06-clean.delta/").select(cols)
...
data_path2 = f"{working_dir}/driftexample/data2"
