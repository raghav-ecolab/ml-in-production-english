...
# MAGIC 
# MAGIC :SIDENOTE: Models can be served in this way in other languages as well.
...
# MAGIC %md
# MAGIC :SIDENOTE: **Remember to shut down the Model Serving Cluster to avoid incurring unexpected cost**. It does not terminate automatically! Click on `Stop` next to `Status` to stop the serving cluster.
# MAGIC <Br>
# MAGIC 
