...
# MAGIC 
# MAGIC :CAUTION: This notebook makes use of the model registry. If you are using the Databricks Community Edition, click the `Upgrade` button on the landing page <a href="https://accounts.cloud.databricks.com/registration.html#login" target="_blank">or navigate here</a> to start a free trial.
...
# MAGIC 
# MAGIC :SIDENOTE: See <a href="https://mlflow.org/docs/latest/registry.html" target="_blank">the MLflow docs</a> for more details on the model registry.
...
# MAGIC 
# MAGIC :SIDENOTE: Explore the UI throughout this lesson by clicking the "Models" tab on the left-hand side of the screen.
...
# MAGIC 
# MAGIC :SIDENOTE: You can load a specific version of the model too.
...
# MAGIC 
# MAGIC :SIDENOTE: You cannot delete a model that is not first archived.
