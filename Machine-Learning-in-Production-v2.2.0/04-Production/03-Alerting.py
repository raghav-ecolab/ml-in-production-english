...
# MAGIC 
# MAGIC :SIDENOTE: Define your own Slack webhook <a href="https://api.slack.com/incoming-webhooks#getting-started" target="_blank">Using these 4 steps.</a><br>
# MAGIC :SIDENOTE: This same approach applies to PagerDuty as well.
...
# MAGIC 
# MAGIC :SIDENOTE: See [SparkListener](https://spark.apache.org/docs/latest/api/java/index.html?org/apache/spark/scheduler/SparkListener.html) docs</a>. You can refer to this [doc](https://kb.databricks.com/metrics/explore-spark-metrics.html).
# MAGIC 
# MAGIC :CAUTION: Be sure to update the webhook variable in the following cell.
