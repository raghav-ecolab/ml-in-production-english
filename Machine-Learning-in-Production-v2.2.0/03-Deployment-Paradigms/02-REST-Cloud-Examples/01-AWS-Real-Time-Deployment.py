...
# MAGIC 
# MAGIC :CAUTION: This step is left up to the user since it depends on your IAM roles
# MAGIC :SIDENOTE: You must create a new SageMaker endpoint for each new region
...
# MAGIC 
# MAGIC :SIDENOTE: See the Secrets API and IAM roles for more secure ways of storing keys.
